...
const conversations: AgentConvo[] = [
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    turns: [
      ...
      { user: 'I am building LeonClaw as an open source project. The repo is at kevint-dot/leonclaw-os on GitHub. It is a Telegram bot powered by Claude Code that runs as a persistent service. I want it to become the reference implementation for personal AI assistants.', assistant: 'Noted. LeonClaw is your open-source reference implementation for personal AI assistants, living at kevint-dot/leonclaw-os.', expectStore: true, label: 'project context' },
    ],
  },
