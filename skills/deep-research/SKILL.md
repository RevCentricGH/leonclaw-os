---
name: deep-research
description: Multi-source research synthesis that produces citation-backed reports. USE THIS WHEN the user says "deep research", "comprehensive analysis", "research report", "compare X vs Y", "analyze trends", "state of the art", or needs a structured report across multiple sources. DO NOT USE THIS WHEN the user is saving a single URL or resource (use research-capture instead), searching X/Twitter for specific posts (use search-x instead), or asking a simple question answerable with 1-2 searches. This skill synthesizes across many sources — it does not save individual resources to the vault.
effort: high
---
